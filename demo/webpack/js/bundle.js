...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloMessageComponent = __webpack_require__(3);
	    ...
	    render: function () {
	        return (
	            React.createElement("div", {className: "component-hello"}, 
	                React.createElement(HelloMessageComponent, {name: wording}), 
	                React.createElement(MovieListComponent, {movies: movies})
	            )
	        )
	    }
	});

	React.render(React.createElement(MainComponent, null), document.getElementById('demo'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 引入子组件
	var MovieComponent = __webpack_require__(5);
	...
	var MovieListComponent = React.createClass({displayName: "MovieListComponent",
	    ...
	    render: function () {
	        ...
	        movies = movies.map(function (movie) {
	            return (
	                React.createElement(MovieComponent, {movie: movie})
	            )
	        }.bind(this));// 注意这里 bind(this) 修正了上下文

	        return (
	            React.createElement("ul", null, movies)
	        )
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloComponent = (function(super$0){super$0=React.Component;if(!PRS$0)MIXIN$0(HelloComponent, super$0);var proto$0={};
	    ...
	    proto$0.render = function() {
	        return React.createElement("div", null, this.state.wording, " ", this.props.name);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieComponent = React.createClass({displayName: "MovieComponent",
	    render: function () {
	        ...
	        return (
	            React.createElement("li", {className: "movie-item", key: movie.id}, 
	                React.createElement("span", {className: "movie-name"}, movie.name), 
	                "-", 
	                React.createElement("span", {className: "movie-date"}, movie.date)
	            )
	        )
	    }
	});
